    ...
    <div class="row">
        <div class="col-md-12">
            <div class="pull-right">
                <button class="btn btn-default btn-red" data-toggle="modal" data-target="#add_nova_campanha_modal">Adicionar Orçamento</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Adicionar descontos</h4>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" id="frm_campanha" enctype="multipart/form-data">
                    <label for="add_descricao_pdf">Tipo desconto</label>
                    <input type="text" id="add_descricao_pdf" name = "add_descricao_pdf" placeholder="Tipo desconto" class="form-control"/>
                </div>

                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="add_data_inicio">Porcentagem</label>
                            <input type="text" id="add_data_inicio" name="add_data_inicio" class="form-control" placeholder="Porcentagem" />
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="">Adicionar Orçamento</button>
                </form>
            </div>
        </div>
    </div>
