        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">                
                        <div class="form-group">
                            <label for="add_select_tipo">Tipo</label>
                            <?php
                                $query = "SELECT id_tipo, tipo_nome FROM tipo_cliente"; 
                                $result = mysqli_query($connect, $query);

                                echo "<select class='form-control select-chosen' id='add_select_tipo' name='add_select_tipo'>";
                                while($row = mysqli_fetch_array($result)) {
                                  echo "<option value='".$row["id_tipo"]."'>".$row["tipo_nome"]."</option>";
                                }
                                echo "</select>";
                            ?>
                        </div>  
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">                
                        <div class="form-group">
                            <label for="upd_select_tipo">Tipo</label>
                            <?php
                                $query = "SELECT id_tipo, tipo_nome FROM tipo_cliente"; 
                                $result = mysqli_query($connect, $query);

                                echo "<select class='form-control select-chosen' id='upd_select_tipo' name='upd_select_tipo'>";
                                while($row = mysqli_fetch_array($result)) {
