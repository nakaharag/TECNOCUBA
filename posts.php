...
<div class="container">
	...
	<div class="row">
		<br />
		<div class="posts_conteudo"></div>
	</div>
    <div class="row">
        <div class="col-md-12">
            <div class="pull-right">
                <button class="btn btn-default btn-red" data-toggle="modal" data-target="#add_nova_campanha_modal">Adicionar Post</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Exibir post</h4>
            </div>
...
<div class="modal fade" id="add_nova_campanha_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Adicionar Post para Whatsapp</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                <form method="post" id="frm_campanha" enctype="multipart/form-data">
                    <label for="add_descricao_pdf">Titulo do Post</label>
                    <input type="text" id="add_descricao_pdf" name = "add_descricao_pdf" placeholder="Titulo do Post" class="form-control"/>
                </div>

                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="add_data_inicio">Data</label>
                            <input type="text" id="add_data_inicio" name="add_data_inicio" class="form-control data" placeholder="Data" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="">Adicionar Post</button>
                </form>
            </div>
        </div>
    </div>
